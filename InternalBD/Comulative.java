...
public class ComulativeAwards {
  ...
  public static class Map extends MapReduceBase implements Mapper < LongWritable, Text, Text, IntWritable > {
    ...
    public void map(LongWritable key, Text value, OutputCollector < Text, IntWritable > output, Reporter reporter) throws IOException {
    	...
    	String[] tokens = myvalue.split(",");
    		...
    		output.collect(new Text("Cumulative years of service done for the company: "),
                      new IntWritable(Integer.parseInt(tokens[3])));
    }
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    conf.setJobName("Comulative years");
